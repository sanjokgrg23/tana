...
function upload_image($image_temp, $img_ext, $album_id){
   $album_id =(int)$album_id;
   mysql_query("INSERT INTO `images` VALUES('','".$_SESSION['user_id']."','$album_id', UNIX_TIMESTAMP(),'$img_ext')");
    
	$image_id = mysql_insert_id();
    $image_file = $image_id.'.'.$img_ext;
